...
<body class=" mx-auto md:max-w-7xl container  p-4">
    <x-navbar>
        ...
        <div class="flex items-center gap-4 md:gap-6 md:ml-auto">
            @auth
                <a href="/jobs/create"
                    class="btn text-white rounded-lg hover:bg-white/15 transition-colors duration-200 text-sm font-semibold shadow-sm">
                    Post a Job
                </a>
            ...
            @else
                ...
                <a href="{{ route('login') }}"
                    class="px-4 py-2 bg-white/10 text-gray-300 rounded-lg hover:bg-white/10 transition-colors duration-200 text-sm font-medium">
                    Login
                </a>
            @endauth
        </div>
